...
# Return a printable house map
def printable_house_map(house_map):
    return "\n".join(["".join(row) for row in house_map])
# Add a pichu to the house_map at the given position, and return a new house_map
...
# To finally arrange agents on the map, the function takes two parameters as input - the house map and the value k, returning a tuple of the form (new_house_map, success), where:
...
if __name__ == "__main__":
    ...
    k = int(sys.argv[2]) # the number of pichus = k
